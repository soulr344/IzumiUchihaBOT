...
WARN_HANDLER = CommandHandler("warn", warn_user, run_async=True, filters=Filters.group)
RESET_WARN_HANDLER = CommandHandler(["resetwarn", "resetwarns"], reset_warns, run_async=True, filters=Filters.group)
REMOVE_WARNS_HANDLER = CommandHandler(["rmwarn", "unwarn"], remove_warns, run_async=True, filters=Filters.group)
CALLBACK_QUERY_HANDLER = CallbackQueryHandler(button, pattern=r"rm_warn")
MYWARNS_HANDLER = DisableAbleCommandHandler("warns", warns, run_async=True, filters=Filters.group)
...
WARN_LIMIT_HANDLER = CommandHandler("warnlimit", set_warn_limit, run_async=True, filters=Filters.group)
WARN_STRENGTH_HANDLER = CommandHandler("strongwarn", set_warn_strength, run_async=True, filters=Filters.group)
